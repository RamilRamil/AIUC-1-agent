...
| Поле | Тип | Правила |
|---|---|---|
| `id` | `str` | тематический слаг: `detectors`, `input-moderation`, … Номер фичи в id **не** кодируется: порядок реализации меняется, за него отвечает `priority` |
...
- `len(controls) == 53`; множество `id` в точности равно
  {A001..A008, B001..B010, C001..C012, D001..D004, E001..E017, F001..F002}
  (E007/E014 — `retired`);
- никаких дублей id.
